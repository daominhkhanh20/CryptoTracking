...
while True:
    ...
    start += 5000
    print(f"Collected {start} tokens")
print(f"Update {len(list_docs)} tokens")
mongodb.bulk_update_one(database='information', collection='token', list_docs=list_docs, list_filters=list_filters)
